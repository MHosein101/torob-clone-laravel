...
class ShopSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $shadvpay = ['', 'امکان پرداخت در محل تا سقف مبلغ '. floor(random_int(500000,100000000)) .' تومان'];
        $shadvdel = ['', 'امکان تحویل در همان روز با هماهنگی'];
        $shadvfree = ['', 'امکان ارسال رایگان برای خریدهای بالای '. floor(random_int(500000,100000000)) .' تومان'];
