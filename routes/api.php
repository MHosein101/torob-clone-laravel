...
Route::get('product/{hash}/sales',[ProductController::class,'getShopsOffers'])->middleware('product');
Route::get('product/{hash}/similars',[ProductController::class,'getSimilarProducts'])->middleware('product');